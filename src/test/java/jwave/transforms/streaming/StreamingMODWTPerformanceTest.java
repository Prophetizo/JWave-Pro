 ...
 * 
 * These tests are ignored by default to avoid slowing down regular test runs.
 * Remove @Ignore to run performance measurements.
 * 
 * @author Prophetizo
 * @date 2025-07-12
 */
@Ignore("Performance tests - run manually")
